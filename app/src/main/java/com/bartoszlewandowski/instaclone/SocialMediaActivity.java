            ...
            try {
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            FancyToast.makeText(SocialMediaActivity.this, "Picture uploaded", Toast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
                        } else {
                            FancyToast.makeText(SocialMediaActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                        }
